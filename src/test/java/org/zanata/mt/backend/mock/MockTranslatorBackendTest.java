...
public class MockTranslatorBackendTest {
    ...
    public void testTranslate() {
        ...
        assertThat(translation.getRawTranslation()).isEqualTo(PREFIX_MOCK_STRING + content);
        assertThat(translation.getPlainTranslation()).isEqualTo(PREFIX_MOCK_STRING + content);
    }
}
